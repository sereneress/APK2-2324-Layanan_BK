...
//echo $email;
$sql_login = tampil("SELECT tbl_pengguna.*, tbl_users.*, tbl_tipe_user.* FROM tbl_pengguna 
...
foreach ($sql_login as $user_login) {
    ...
    $photo = $user_login['path_photo_pengguna'];
...
<head>
    ...
    <title>Pengguna - Layanan Bimbingan Konseling</title>
</head>
